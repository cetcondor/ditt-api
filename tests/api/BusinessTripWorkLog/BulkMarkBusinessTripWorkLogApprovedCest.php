...
class BulkMarkBusinessTripWorkLogApprovedCest
{
    /**
     * @var User|null
     */
    ...
    public function testMarkApproved(\ApiTester $I): void
    {
        ...
        $workLog2 = $I->createBusinessTripWorkLog([
            'workMonth' => $workMonth,
        ]);

        $I->haveHttpHeader('Content-Type', 'application/json');
        $I->sendPUT(
            '/business_trip_work_logs/bulk/mark_approved',
        ...
        $workLog2 = $I->grabEntityFromRepository(BusinessTripWorkLog::class, [
            'id' => $workLog2->getId(),
        ]);
